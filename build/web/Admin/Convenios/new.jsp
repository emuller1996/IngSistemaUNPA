                        ...
                        <div class="row  bg-light rounded align-items-center justify-content-center mx-0  p-4" >
                            <form action="Convenios" method="post" enctype="multipart/form-data" >
                                <div class="form-floating mb-3">
                                    ...
                                    <input name="convenio_nombre_reg" type="Text" class="form-control" id="floatingInput" placeholder="s   ">
                                    <label for="floatingInput">Titulo Convenio</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <textarea name="convenio_descripcion_reg" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
                                    <label for="floatingTextarea2">Descripcion Convenio</label>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input name="convenio_fecha_reg" type="date" class="form-control" id="floatingInput" placeholder="s   ">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            ...
                                            <select name="convenio_origen_reg" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <select name="convenio_vigente_reg" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input name="curso_pdf_reg" type="file" class="form-control" id="floatingInput" placeholder="s   ">
